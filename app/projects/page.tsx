...
const projects2026 = projects
  .filter(p => [3, 13, 14, 15].includes(p.id))
  .sort((a, b) => [3, 13, 14, 15].indexOf(a.id) - [3, 13, 14, 15].indexOf(b.id))
...
const previousProjects = projects.filter(p => ![3, 13, 14, 15, 11, 12, 10, 9, 1, 7, 8].includes(p.id))

export default function ProjectsPage() {
  return (
    <SiteLayout>
      <div className="container px-4 py-12 mx-auto space-y-16">
        {/* 2026 Projects Section */}
        <section>
